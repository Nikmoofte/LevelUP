...
namespace Viewer
{
    ...
    ShaderProg::ShaderProg(ShaderProg &&other) : id(other.id), UniformLocCache(std::move(other.UniformLocCache))
    {
    }

    ShaderProg::ShaderProg(const ShaderProg &other) : id(other.id), UniformLocCache(other.UniformLocCache){}
